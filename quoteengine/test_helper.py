...
def get_csvfile_quotemode():
    ...
    expected = [
        str(QuoteModel('Every artist was first an amateur', 'Ralph Waldo Emerson')),
        ...
        str(QuoteModel('You don’t take a photograph - you make it', 'Ansel Adams')),
        str(QuoteModel('Art enables us to find ourselves ' \
                       'and lose ourselves at the same time', 
                       'Thomas Merton')),
        str(QuoteModel('We don’t make mistakes - just happy little accidents', 'Bob Ross')),
        str(QuoteModel('Have no fear of perfection - you’ll never reach it', 'Salvador Dali')),
